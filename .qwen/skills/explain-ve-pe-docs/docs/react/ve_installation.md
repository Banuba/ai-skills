# Banuba Video Editor React Native
...
## Integration guide
Please follow our [Integration Guide](https://docs.banuba.com/ve-pe-sdk/docs/react/ve_integration) to complete full integration.

## Launch
Set Banuba license token [within the app](https://github.com/Banuba/ve-sdk-react-native/blob/master/example/src/App.tsx#L24)
