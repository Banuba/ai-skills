...
Next, specify it in the [start method](https://github.com/Banuba/ve-sdk-flutter/blob/master/example/lib/main.dart#L66) of the Video Editor:
...
Specify your watermark in the [pubspec.yaml](https://github.com/Banuba/ve-sdk-flutter/blob/master/example/pubspec.yaml#L50) and provide it to the ```ExportData``` instance:
