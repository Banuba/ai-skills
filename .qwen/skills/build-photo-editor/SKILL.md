...
description: |
  ...
  assistant: "I'll use /build-photo-editor to help set this up."
  </example>

  <example>
  Context: User wants to add a specific feature
  user: "Add new feature to my photo editor"
  assistant: "Let me use /build-photo-editor to implement this feature."
  </example>
---

## Version Notice

Generated for Banuba Photo Editor SDK on 2026-08-11. Latest versions: Android v1.4.1, iOS v1.4.1, Flutter v0.6.0, React Native v0.7.0. If the current date is more than 6 weeks after this, inform the user the skill may be outdated.
