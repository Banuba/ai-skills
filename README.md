...
The build skills include starter kit templates for common use cases like Face AR apps, video editors or photo editors. They detect your project's platform and generate code accordingly.
