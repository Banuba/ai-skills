# Explain mode: documentation lookup reference

Read this for Explain mode: documentation, concepts, API guidance, and troubleshooting. To build, scaffold, or edit project files, switch to Build mode and follow `reference/build.md`. For hybrid requests, use both.
...
- For writing code, scaffolding, or editing project files, switch to Build mode and follow `reference/build.md`.
