...
* New Effect Player API for Web, iOS & Android. Information about migration can be [here](./development/guides/migration)
...
MacOS: Video processing on MacOS
...
* Virtual Background:
*`Background.getBackgroundVideo()` method added
...
* Virtual background: [video formats](./capabilities/technical_specification#video-formats-support) support updates
...
## [1.4.0] - 2022-04-20
**Added**
* Face AR SDK for [iOS](./development/installation) and [Android](./development/installation) distribution as pods or maven packages
* iOS, Android: All Face AR SDK [examples on Github](./development/samples) are switched to pods, and Maven packages
...
* WebAR: Check out our new [tutorials section](./development/basic_integration) with extensive WebAR insides and best-practices
...
* [SDK Manager](pathname:///generated/javadoc/banuba_sdk/com/banuba/sdk/manager/package-summary.html) added to the API documentation
* AR Rings technology
...
* Ability to [combine Face AR effects](/effects/virtual_background) with a virtual background in runtime
...
**Changed**
* [Examples apps](./development/samples.md) optimised for SDK v1.x
...
**Changed**
* Persistent OpenGL context on Android (don't recreate it after the app
goes in background)
...
## [0.23.0] - 2019-10-02
**Added**
* A neural network based approach to detecting faces. Quality, detection angles, and speed of the face
...
* Process image improved
**Fixed**
* Exposure point settings (iOS)
**Added**
