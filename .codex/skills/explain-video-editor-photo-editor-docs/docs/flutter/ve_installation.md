...
```
dependencies:
    ve_sdk_flutter: ^0.45.0
```

## Integration guide
Please follow our [Integration Guide](https://docs.banuba.com/ve-pe-sdk/docs/flutter/ve_integration) to complete full integration.
