...
description: |
  ...
  user: "How do I customize the camera screen in Banuba Video Editor SDK?"
  assistant: "I'll use /explain-video-editor-photo-editor-docs to look up the camera guide."
  </example>
